...
## Structure generator interface. A generator is a Resource that carries its own
...
## Generators are config: hash_fold folds the class name (so two generators with
