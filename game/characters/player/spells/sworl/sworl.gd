...
## Sworl: orbs orbit the caster for the duration, damaging enemies they sweep
...
const _OrbScene = preload("res://characters/player/spells/sworl/sworl_orb.tscn")

var data: SworlResource
var skill: int = 0
