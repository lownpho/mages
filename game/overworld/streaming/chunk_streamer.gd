...
const _PORTAL := preload("res://overworld/runtime/portal.tscn")
const _SIGN := preload("res://overworld/runtime/sign.tscn")
const _DUNGEON_PLACEHOLDER := preload("res://overworld/runtime/dungeon_placeholder.tscn")
