...
## Run: godot --headless --path game world_gen/tests/test_specials_hb.tscn
...
func _check_boss_reservation() -> Array[String]:
	var fails: Array[String] = []
	var glade: Resource = load("res://world_gen/content/biomes/glade.tres")
	var biome: Resource = load("res://world_gen/content/biomes/deepwood.tres").duplicate(true)
