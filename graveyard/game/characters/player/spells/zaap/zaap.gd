...
# Nearest hostile across the caster's target groups, excluding the enemy just
# zapped — the chain re-targets by proximity, not aim, so it can't reuse cone math.
